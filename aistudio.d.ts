...
interface Window {
  // FIX: Removed the `readonly` modifier to resolve a conflict with another global declaration of `aistudio`.
  // All declarations for the same property on an interface must have identical modifiers.
  aistudio: AIStudio;
}
