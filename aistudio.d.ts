...
interface Window {
  // FIX: Added 'readonly' modifier to resolve the "All declarations of 'aistudio' must have identical modifiers" error. This ensures this declaration matches another one elsewhere in the project.
