...
const ThemeSelector: React.FC<ThemeSelectorProps> = ({ onClose }) => {
    ...
    return (
        <div 
            className="absolute top-full mt-2 right-0 w-48 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg shadow-xl z-20 animate-fade-in"
            style={{ animationDuration: '0.2s' }}
            // Clicks inside are handled by buttons, no need for stopPropagation
        >
            <div className="p-2">
